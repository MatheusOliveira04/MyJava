...
public class Program {
	...
	public static void main(String[] args) {
		...
		//or
		//List<String> name = list.stream().map(new MyFunction()).collect(Collectors.toList()); //or
		//List<String> name = list.stream().map(Product::staticFunction).collect(Collectors.toList()); //or
